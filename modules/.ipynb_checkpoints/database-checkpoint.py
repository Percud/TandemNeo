...
class dbinfo:
    ...
    def aclist_convertid(specie, kind, ID_kind):
        ...
        if ID_kind == 'protein':
            ...
            ortholist = [js.get(l)['gene id'] for l in ortholist] 
        elif ID_kind == 'transcript':
            ortholist = [js.get(l)['transcript id'] for l in ortholist]
        
        return ortholist

        # dbinfo.aclist_convertid('homo_sapiens', 'convergent', 'gene')