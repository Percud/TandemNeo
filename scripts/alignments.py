...
class alignments:
    ...
    def log(falnfile, srefs, matrix):
        ...
        consensus = [
            AlignInfo.SummaryInfo(total).dumb_consensus()]+[
                ...
                dfs.append(
                    pd.DataFrame([
                        ...
                        index=['pair', 'ab', 'consensus', 'position',
                               'ensembl_ac_protein', 'ensembl_num', 'col', 'res', 'consensus_ac',
                               'ensembl_ac_protein_partner', 'ensembl_num_partner', 'col_partner', 
                               'res_partner', 'consensus_ac_partner',
                               'scores','total_scores>' + str(threshold), 'total_scores']
